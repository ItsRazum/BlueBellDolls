...
namespace BlueBellDolls.Common.Providers
{
    public class CommonKeyboardsProvider : ICommonKeyboardsProvider
    {
        ...
        public InlineKeyboardMarkup CreateCloseFeebackRequestKeyboard(int feedbackRequestId)
            => InlineKeyboardButton.WithCallbackData("Закрыть запрос", $"closeFeedbackRequest-{feedbackRequestId}");
    }
}
